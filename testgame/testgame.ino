...
void setup()
{
  ...
  if (checkButton() == CHOICE_GREEN)
  {
    ...
    setLEDs(CHOICE_RED | CHOICE_BLUE ); // Turn on the other LEDs until you release button
...
void loop()
{
  ...
  lcd.setCursor(0,1);
  lcd.print("High Score ");//High Score At Home Screen
  lcd.print(highScore);
